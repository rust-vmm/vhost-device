...
impl_transfer3d_from_desc!(Transfer3D); // rutabaga_gfx::Transfer3D
impl_transfer3d_from_desc!(VirglTransfer3D); // virglrenderer::Transfer3D
...
// A neutral representation of a virtio-gpu resource.
// This is what the device.rs logic will work with.
#[derive(Default, Clone)]
pub struct GpuResource {
    pub id: u32,
    pub width: u32,
    pub height: u32,
    // You would add other fields here that are common to all backends.
    // For example, a shared handle type, scanout information, etc.
}
