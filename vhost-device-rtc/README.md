...
The `vhost-device-rtc` binary exposes three kinds of clocks:

- `CLOCK_MONOTONIC` (POSIX)
- `CLOCK_REALTIME` (i.e. UTC clock) (POSIX)
- `CLOCK_TAI`

All the clocks are enabled by default and can be individually disabled by command-line arguments.

For alarm functionality, refer to the alarm section of this README.
