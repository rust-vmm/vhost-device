...
mod tests {
    ...
    fn verify_cmd_line_arguments() {
        ...
        assert!(VuRngConfig::try_from(default_args).is_ok());

        // Setting a invalid period should triggers an InvalidPeriodInput error.
        ...
        // Setting the socket count to 0 should triggers an InvalidSocketCount error.
