...
impl<D: SpiDevice> VhostUserSpiBackend<D> {
    ...
    fn process_requests(
        ...
        let in_hdr = match self.spi_ctrl.check_trans_params(&mut reqs) {
...
mod tests {
    ...
    fn process_requests_success() {
        ...
        validate_trans_result(mem.clone(), trans_result_addr1, VIRTIO_SPI_TRANS_OK);
        ...
        validate_trans_result(mem.clone(), trans_result_addr2, VIRTIO_SPI_TRANS_OK);
        ...
        validate_trans_result(mem.clone(), trans_result_addr1, VIRTIO_SPI_PARAM_ERR);
