...
/// regions. Returns the created VringRwLock, a vector of output buffer address
/// vectors, and the EventFd used for call notifications.
pub fn create_vring(
...
/// Convert an EventFd into a File, transferring ownership of the underlying FD.
