...
use crate::{vhu_spi::VirtioSpiConfig, virtio_spi::*};
...
impl<D: SpiDevice> SpiController<D> {
    ...
    pub(crate) fn check_trans_params(&self, reqs: &mut [SpiTransReq]) -> bool {
...
pub(crate) mod tests {
    ...
    pub fn update_rdwr_buf(buf: u64, len: u32) {
        ...
        // SAFETY: Safe as the input buffer is valid.
        unsafe {
            for i in 0..len {
    ...
    fn test_spi_ctrl_param_check() {
        ...
        assert!(spi_dummy_ctrl.check_trans_params(&mut reqs));
